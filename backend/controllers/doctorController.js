...
// this function will covert doctor data into a plain text
...
export const getDoctors = async (req, res) => {
  try {
    ...
    const total = await Doctor.countDocuments(match); // total num of doctors
...
// get Doctor by id to fetch one doctor
