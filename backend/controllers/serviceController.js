...
// Helper Function
// so this function converts array like input into clean array
...
// this function takes data-time slot strings and group them into a 
      ...
      try {
        ...
        if (up?.secure_url) {
          ...
          if (existing.imagePublicId) {
            // it will remove the old image and replace it with new one
            try {
