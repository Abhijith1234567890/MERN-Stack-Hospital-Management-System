...
// Helper functions
// this function will give output in minutes and acconrding to that it will manage am : pm
...
// this function will convert {YYY-MM-DD} to Date Month Year
...
const AddPage = () => {
  ...
  function addSlotToForm() {
    ...
    // if date is of today prevent from time
    if (slotDate === today) {
      const now = new Date();
