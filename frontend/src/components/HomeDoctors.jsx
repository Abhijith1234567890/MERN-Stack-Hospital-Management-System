...
import { ChevronRight, Medal, MousePointer2OffIcon } from "lucide-react";
  ...
  return (
    <section className={homeDoctorsStyles.section}>
      <div className={homeDoctorsStyles.container}>
        ...
        {/* here it will re fetch the api to get response */}
        {loading ? (
                  ...
                  <div className={homeDoctorsStyles.buttonContainer}>
                    <div className="w-full">
                      {doctor.available ? (
                        ...
                        <button className={homeDoctorsStyles.buttonAvailable}>
                          <MousePointer2OffIcon className="w-5 h-5" />
                          Not Available
                        </button>
                      )}
                    </div>
